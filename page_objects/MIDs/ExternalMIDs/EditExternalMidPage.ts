...
export class EditExternalMidPage extends BasePage
{
    ...
    public async editExternalMID(data: Partial<ExternalMidType>): Promise<boolean>
    {
        await expect(this.pageLoaded).toBeHidden();
        await this.form.checkIsDisabled('Project');
        await this.form.checkIsDisabled('Provider');
