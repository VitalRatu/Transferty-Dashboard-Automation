...
test('MasterCard 5413330300003002 Payment', async ({ merchantUser }) => 
{
    await test.step('User clicks on "Transactions" tab', async() =>
    {
        await merchantUser.dashboardPage.sidebar.openSidebarTab('Transactions');
...
test('MasterCard 5555555555554444 Payment', async ({ merchantUser }) => 
{
    await test.step('User clicks on "Transactions" tab', async() => 
    {
        await merchantUser.dashboardPage.sidebar.openSidebarTab('Transactions');
...
test('Amex 371449635398431 Payment', async ({ merchantUser }) => 
{
    await test.step('User clicks on "Transactions" tab', async() => 
    {
        await merchantUser.dashboardPage.sidebar.openSidebarTab('Transactions');
...
test('Unionpay 6212345678901232 Payment', async ({ merchantUser }) => 
{
    await test.step('User clicks on "Transactions" tab', async() => 
    {
        await merchantUser.dashboardPage.sidebar.openSidebarTab('Transactions');
